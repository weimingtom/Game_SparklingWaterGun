...
PADSET	iexInput::ps101 = { AXIS_X, AXIS_Y, AXIS_Z, AXIS_RZ,
AXIS_SLIDERX, AXIS_SLIDERY,									2, 3, 1, 4, 7, 5, 11, 8, 6, 12, 9, 10 };	// ELECOM JS-PS101USV
PADSET	iexInput::sixaxis = { AXIS_X, AXIS_Y, AXIS_Z, AXIS_RZ, AXIS_SLIDERX, AXIS_SLIDERY, 2, 3, 1, 4, 7, 5, 10, 8, 6, 11, 12, 9 };	// SixAxis	
PADSET	iexInput::xbox360 = { AXIS_X, AXIS_Y, AXIS_RX, AXIS_RY, AXIS_SLIDERX, AXIS_SLIDERY, 1, 2, 3, 4, 5, 11, 9, 6, 12, 10, 7, 8 };	// XBOX360 Controller
PADSET	iexInput::ps3 = { AXIS_X, AXIS_Y, AXIS_RX, AXIS_RY,
AXIS_SLIDERX, AXIS_SLIDERY,									1, 2, 3, 4, 5, 11, 9, 6, 12, 10, 7, 8 };

PADSET	iexInput::padset_School = { AXIS_X, AXIS_Y, AXIS_Z, AXIS_RZ, AXIS_SLIDERX, AXIS_SLIDERY, 3, 2, 4, 1, 5, 7, 11, 6, 8, 12, 9, 10 };
...
void iexInput::SetInfo()
{
	...
	if( lpDevice ){
		...
		if( lpDevice->GetDeviceState(sizeof(DIJOYSTATE2),&js) == DI_OK ){
			...
			axis[4] = js.lRy;
			axis[5] = js.lRz;
			axis[6] = js.rglSlider[0];
			axis[7] = js.rglSlider[1];
			...
			PadAxisX3 = axis[JoyMap[16]];	//	ジャイロＸ軸
			PadAxisY3 = axis[JoyMap[17]];	//	ジャイロＹ軸
...
int	iexInput::Get( KEYCODE key )
{
	...
	case KEY_AXISX3:	return PadAxisX3;
	case KEY_AXISY3:	return PadAxisY3;
	}
	return KeyInfo[key];
}
