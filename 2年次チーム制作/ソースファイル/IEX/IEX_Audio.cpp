...
//
//**************************************************************************************************************
void	iexSound::Set(iexSoundNumber no, char* filename, bool b3D)
{
	//	初期化チェック
	if( lpDS == NULL ) return;
	//	既存のバッファの解放
...
void iexSound::Play(iexSoundNumber no, BOOL loop)
{
	//	初期化チェック
	if( lpDS == NULL ) return;
	//	データが無い！！
...
void iexSound::Stop(iexSoundNumber no)
{
	//	初期化チェック
	if( lpDS == NULL ) return;
	//	データが無い！！
...
/*	ボリュームの設定	*/ 
void	iexSound::SetVolume(iexSoundNumber no, int volume)
{
	//	初期化チェック
	if( lpDS == NULL ) return;
	//	データが無い！！
...
/*	再生状況のチェック	*/ 
BOOL	iexSound::isPlay(iexSoundNumber no)
{
	//	初期化チェック
...
/*	バッファ準備	*/ 
BOOL	IEX_SetWAV(iexSoundNumber no, LPSTR filename, bool b3D)
{
...
/*	ボリュームの設定	*/ 
void	IEX_SetSoundVolume(iexSoundNumber no, int volume)
{
